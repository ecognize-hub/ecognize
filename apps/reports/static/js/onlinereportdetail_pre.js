...
function sendMessageToThread(threadId, inputId){
    const targetUrl = Urls['api-onlinereport-commentthreads-send'](document.getElementById("id_report_id").value, threadId) + "?format=json";
...
function loadReportComments() {
    ...
    const targetUrl = Urls['api-onlinereport-commentthreads-list'](reportId) + "?format=json";
...
function startThread(){
    ...
    const targetUrl = Urls['api-onlinereport-commentthreads-start'](reportId) + "?format=json";
