...
document.getElementById("id_button_uploadReplaceFile").addEventListener("click", function(e){ const objId = parseInt(document.getElementById('id_input_object_id_uploadReplace').value); replaceFileContentAndRefresh(objId); }, false);
...
function loadObjects(){
    const fileId = parseInt(document.getElementById("id_file_id").value);
    loadSingleFileInfo(fileId);
}
