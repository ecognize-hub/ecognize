...
templates['chatmsg_mine.hbs'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"row py-4\" id=\""
    ...
    + "\n                </div>\n            </div>\n            <div class=\"row\">\n                <div class=\"col\">\n                    <small>"
    + alias4(((helper = (helper = lookupProperty(helpers,"sent_timestamp") || (depth0 != null ? lookupProperty(depth0,"sent_timestamp") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"sent_timestamp","hash":{},"data":data,"loc":{"start":{"line":11,"column":27},"end":{"line":11,"column":47}}}) : helper)))
